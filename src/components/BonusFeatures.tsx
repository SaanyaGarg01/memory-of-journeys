...
import { Mail, Thermometer, Users, Mic, Image, FileText, ArrowRight, Flower2 } from 'lucide-react';
...
export default function BonusFeatures({ onFeatureClick }: BonusFeaturesProps) {
  const features = [
    ...
    },
    {
      ...
      title: 'Virtual Memory Garden',
      description: 'Each trip plants a symbolic flower that blossoms over time in your personal digital garden',
      color: 'from-green-500 to-emerald-500',
      available: true
    }
  ];
